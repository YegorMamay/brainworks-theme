...
/**
 * Blog index template.
 * Шаблон главной страницы блога (список записей).
 * Используется, когда на главной отображаются последние записи или когда главная — статическая страница, а это шаблон для страницы «Записи».
 *
 * @package Brainworks
 */
